...
超级码APP项目中码定义码关联功能模块。
  ...
  s.source           = { :svn => 'svn://localhost/ios_database_mine/Jiaguwen/iOS/SuperCode/SCFoundation', :tag => s.version.to_s }
